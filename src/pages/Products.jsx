    ...
    <main className="min-h-screen">
      ...
      <section className="bg-transparent py-0">
        <div className="bg-white">
          <ColorBlooms
            items={[
              { hue: "blue",color: "rgba(59,130,246,0.3)", size: 2200, top: "55%",  right: "40%", falloff: "84%", blurPx: 110 },
              { hue: "sky", color: "rgba(56,189,248,0.3)", size: 2800, top: "10%",  right: "40%", falloff: "84%", blurPx: 110 },
